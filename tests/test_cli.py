...
class TestCliMain:
    ...
    def test_cli_basic_download(self):
        ...
        with patch("media_archive_sync.cli.crawl_archive") as mock_crawl:
            with patch("media_archive_sync.cli.download_with_config") as mock_download:
    ...
    def test_cli_quiet_mode(self):
        """Test CLI quiet mode."""
        with patch("media_archive_sync.cli.crawl_archive") as mock_crawl:
            with patch("media_archive_sync.cli.download_with_config"):
                mock_crawl.return_value = (
                    [("http://example.com/video.mp4", "video.mp4")],
                    {},
                )
    ...
    def test_cli_organize_mode(self):
        ...
        with patch("media_archive_sync.cli.crawl_archive") as mock_crawl:
            with patch("media_archive_sync.cli.download_with_config"):
                # Import is done inside the function, patch at source
                with patch(
